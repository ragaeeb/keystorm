...
/**
 * PunctuationPage - Tutorial for typing punctuation marks and symbols
            ...
            <div className="mx-auto max-w-6xl">
                <Card className="shadow-xl">
                    <CardHeader className="text-center">
                        <CardTitle className="text-3xl">Master Punctuation & Symbols</CardTitle>
                        <CardDescription className="space-y-2">
                            <p className="text-base">
                                Punctuation marks add meaning to your writing. Learn where each symbol lives and which
                                finger to use.
                            </p>
                        </CardDescription>
                    </CardHeader>
                    ...
                    <CardContent className="space-y-8">
                                ...
                                <CardContent className="pt-6">
                                    ...
                                    <ol className="space-y-2 text-sm">
                                        ...
                                        <li className="flex gap-2">
                                            ...
                                            <span>
                                                Right pinky to <kbd className="rounded bg-gray-200 px-2 py-1">'</kbd>{' '}
                                                apostrophe key
                                            </span>
                                        </li>
                                        <li className="flex gap-2">
                                        ...
                                        <li className="flex gap-2">
                                            ...
                                            <span>
                                                Hold Shift + 1 for{' '}
                                                <kbd className="rounded bg-gray-200 px-2 py-1">!</kbd> exclamation
                                            </span>
                                        </li>
                                    </ol>
                                </CardContent>
                                    ...
                                    <ol className="space-y-2 text-sm">
                                        ...
                                        <li className="flex gap-2">
                                            ...
                                            <span>
                                                ...
                                                <kbd className="rounded bg-gray-200 px-2 py-1">,</kbd> comma
                                            </span>
                                        </li>
                                        <li className="flex gap-2">
                                            <span className="font-bold">3.</span>
                                        ...
                                        <li className="flex gap-2">
                                            ...
                                            <span>
                                                ...
                                                <kbd className="rounded bg-gray-200 px-2 py-1">.</kbd> period
                                            </span>
                                        </li>
                                    </ol>
                                </CardContent>
                        ...
                        <form action="/practice" className="text-center">
                            <Button type="submit" size="lg" className="bg-gradient-to-r from-indigo-600 to-purple-600">
                                Press Enter to Start Punctuation Practice
                            </Button>
                        </form>
                    </CardContent>
                </Card>
